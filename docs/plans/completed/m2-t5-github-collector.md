...
- [x] run linter-equivalent validation with go vet ./...
- [x] verify new GitHub package tests cover client retry/rate-limit paths, cache behavior, parser mapping, and collector orchestration with at least 80% package coverage
